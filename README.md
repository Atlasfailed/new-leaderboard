...
The pipeline uses the BAR datamarts only. Nation rankings are rating/depth based, and team rankings are based on roster rating, opponent difficulty, and performance against expected win rate.
